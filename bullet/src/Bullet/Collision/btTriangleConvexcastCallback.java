 ...
 */
public abstract class btTriangleConvexcastCallback implements btTriangleCallback,
 Serializable {
 ...
 btTriangleConvexcastCallback(btConvexShape convexShape,
  final btTransform convexShapeFrom,
  final btTransform convexShapeTo, final btTransform triangleToWorld,
 ...
 public boolean processTriangle(btVector3[] triangle, int partId,
  int triangleIndex) {
  btTriangleShape triangleShape = new btTriangleShape(triangle[0], triangle[1],
   triangle[2]);
  ...
  btContinuousConvexCollision convexCaster = new btContinuousConvexCollision(
   m_convexShape,
 ...
 abstract float reportHit(final btVector3 hitNormalLocal,
