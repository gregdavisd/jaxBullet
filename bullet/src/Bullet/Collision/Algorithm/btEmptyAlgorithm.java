...
/**
 * EmptyAlgorithm is a stub for unsupported collision pairs. The dispatcher can
 * dispatch a persistent btEmptyAlgorithm to avoid a search every frame.
 *
 * @author Gregery Barton
 */
public class btEmptyAlgorithm extends btCollisionAlgorithm implements
 Serializable {
