...
public abstract class btCollisionAlgorithm  implements Serializable {
 ...
 public abstract float calculateTimeOfImpact(btCollisionObject body0, btCollisionObject body1,
  btDispatcherInfo dispatchInfo, btManifoldResult resultOut);

 public abstract void getAllContactManifolds(ArrayList<btPersistentManifold> manifoldArray);
