 ...
 */
public class btBoxBoxCollisionAlgorithm extends btActivatingCollisionAlgorithm  implements Serializable {
 ...
 btBoxBoxCollisionAlgorithm(btPersistentManifold mf, btCollisionAlgorithmConstructionInfo ci,
  btCollisionObjectWrapper body0Wrap, btCollisionObjectWrapper body1Wrap) {
  super(ci, body0Wrap, body1Wrap);
  if (mf == null && m_dispatcher.needsCollision(body0Wrap.getCollisionObject(), body1Wrap
   .getCollisionObject())) {
