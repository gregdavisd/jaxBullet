 ...
 */
public class BridgeTriangleConvexcastCallbackB extends btTriangleConvexcastCallback  implements Serializable {

 final ConvexResultCallback m_resultCallback;
 final btCollisionObject m_collisionObject;

 BridgeTriangleConvexcastCallbackB(btConvexShape castShape, final btTransform from,
  final btTransform to,
  ConvexResultCallback resultCallback, btCollisionObject collisionObject,
  btConcaveShape triangleMesh, final btTransform triangleToWorld) {
 ...
 @Override
 float reportHit(final btVector3 hitNormalLocal, final btVector3 hitPointLocal, float hitFraction,
