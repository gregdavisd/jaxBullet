 ...
 */
public class BridgeTriangleConvexcastCallbackB extends btTriangleConvexcastCallback
 implements
 Serializable {
 ...
 BridgeTriangleConvexcastCallbackB(btConvexShape castShape,
  final btTransform from,
