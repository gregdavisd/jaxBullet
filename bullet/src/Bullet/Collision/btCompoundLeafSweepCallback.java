 ...
 */
public class btCompoundLeafSweepCallback extends btDbvt.ICollide implements Serializable  {

 btCompoundLeafSweepCallback(
  btCollisionObjectWrapper colObjWrap,
  btConvexShape castShape, final btTransform convexFromTrans, final btTransform convexToTrans,
 ...
 void processChild(int index, final btTransform childTrans, btCollisionShape childCollisionShape) {
  ...
  btCollisionObjectWrapper tmpObj = new btCollisionObjectWrapper(m_colObjWrap, childCollisionShape,
   m_colObjWrap.getCollisionObject(), childWorldTrans, -1, index);
  objectQuerySingleInternal(m_castShape, m_convexFromTrans, m_convexToTrans, tmpObj, my_cb,
