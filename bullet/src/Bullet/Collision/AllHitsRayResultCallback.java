 ...
 */
public class AllHitsRayResultCallback extends RayResultCallback implements
 Serializable {

 private static final long serialVersionUID = 1L;
 public final ArrayList<  btCollisionObject> m_collisionObjects = new ArrayList<>(
  0);
 ...
 public AllHitsRayResultCallback(final btVector3 rayFromWorld,
 ...
 public float addSingleResult(LocalRayResult rayResult,
  ...
  if (normalInWorldSpace) {
   ...
   hitNormalWorld.set(m_collisionObject.getWorldTransformPtr().transform3x3(
    new btVector3(
