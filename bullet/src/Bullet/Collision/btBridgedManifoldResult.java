 ...
 */
public class btBridgedManifoldResult extends btManifoldResult implements
 Serializable {

 final ContactResultCallback m_resultCallback;

 public btBridgedManifoldResult(btCollisionObjectWrapper obj0Wrap,
 ...
 public void addContactPoint(final btVector3 normalOnBInWorld,
  ...
  boolean isSwapped = m_manifoldPtr.getBody0() != m_body0Wrap
   .getCollisionObject();
  final btVector3 pointA = new btVector3(pointInWorld).add(new btVector3(
   normalOnBInWorld).scale(
   depth));
