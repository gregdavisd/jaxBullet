 ...
 */
public class btGjkEpaPenetrationDepthSolver implements btConvexPenetrationDepthSolver ,   Serializable {
  ...
  */
 @Override
 public boolean calcPenDepth(btSimplexSolverInterface simplexSolver, btConvexShape convexA,
  btConvexShape convexB, final btTransform transformA, final btTransform transformB,
  final btVector3 v, final btVector3 wWitnessOnA, final btVector3 wWitnessOnB,
  btIDebugDraw debugDraw) {
//	  float				radialmargin(float(0.));
  final btVector3 guessVector = transformB.getOrigin().sub(transformA.getOrigin());
