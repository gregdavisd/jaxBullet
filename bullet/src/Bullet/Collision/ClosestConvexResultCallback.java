 ...
 */
public class ClosestConvexResultCallback extends ConvexResultCallback implements
 Serializable {
 ...
 public ClosestConvexResultCallback(final btVector3 convexFromWorld,
  final btVector3 convexToWorld) {
...
//caller already does the filter on the m_closestHitFraction
  ...
  if (normalInWorldSpace) {
   ...
   m_hitNormalWorld.set(m_hitCollisionObject.getWorldTransformPtr()
