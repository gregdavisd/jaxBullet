...
abstract public class btBroadphaseInterface implements Serializable {
 ...
 public abstract btBroadphaseProxy createProxy(final btVector3 aabbMin,
  final btVector3 aabbMax,
  int shapeType,
  Object userPtr, int collisionFilterGroup, int collisionFilterMask,
  btDispatcher dispatcher);

 public abstract void destroyProxy(btBroadphaseProxy proxy,
  btDispatcher dispatcher);
 ...
 public abstract void getBroadphaseAabb(final btVector3 aabbMin,
  final btVector3 aabbMax);
