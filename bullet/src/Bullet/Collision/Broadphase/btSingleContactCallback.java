...
public class btSingleContactCallback extends btBroadphaseAabbCallback  implements Serializable {
 ...
 public btSingleContactCallback(btCollisionObject collisionObject, btCollisionWorld world,
 ...
 boolean process(btBroadphaseProxy proxy) {
  ...
  if (m_resultCallback.needsCollision(collisionObject.getBroadphaseHandle())) {
   btCollisionObjectWrapper ob0 = new btCollisionObjectWrapper(null, m_collisionObject
    .getCollisionShape(), m_collisionObject, m_collisionObject.getWorldTransformPtr(), -1, -1);
   btCollisionObjectWrapper ob1 = new btCollisionObjectWrapper(null, collisionObject
    .getCollisionShape(), collisionObject, collisionObject.getWorldTransformPtr(), -1, -1);
   btCollisionAlgorithm algorithm = m_world.getDispatcher().findAlgorithm(ob0, ob1, null,
    BT_CLOSEST_POINT_ALGORITHMS);
   if (algorithm != null) {
    btBridgedManifoldResult contactPointResult = new btBridgedManifoldResult(ob0, ob1,
     m_resultCallback);
