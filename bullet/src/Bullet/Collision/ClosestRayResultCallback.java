...
public class ClosestRayResultCallback extends RayResultCallback  implements Serializable {
 ...
 public ClosestRayResultCallback(final btVector3 rayFromWorld, final btVector3 rayToWorld) {
 ...
 float addSingleResult(LocalRayResult rayResult,
  ...
  if (normalInWorldSpace) {
   ...
   m_hitNormalWorld.set(m_collisionObject.getWorldTransformPtr().transform3x3(new btVector3(
