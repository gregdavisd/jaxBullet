 ...
 */
public class MyNodeOverlapCallbackAllTriangles implements btNodeOverlapCallback,
 Serializable {
 ...
 public MyNodeOverlapCallbackAllTriangles(btTriangleCallback callback,
 ...
 public void processNode(int nodeSubPart, int nodeTriangleIndex) {
   ...
   */
  mesh_lock.process_all_triangles(vert_scaling_callback, nodeSubPart,
   nodeTriangleIndex);
