 ...
 */
public class btClosestNotMeConvexResultCallback extends ClosestConvexResultCallback
 implements
 Serializable {
 ...
 btClosestNotMeConvexResultCallback(btCollisionObject me, final btVector3 fromA,
  final btVector3 toA,
 ...
 public float addSingleResult(LocalConvexResult convexResult,
  ...
  final btVector3 linVelA = new btVector3(m_convexToWorld)
   .sub(m_convexFromWorld);
