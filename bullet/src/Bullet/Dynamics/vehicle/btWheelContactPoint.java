...
public class btWheelContactPoint implements Serializable {
 ...
 public btWheelContactPoint(btRigidBody body0, btRigidBody body1,
  final btVector3 frictionPosWorld,
  ...
  float denom0 = body0.computeImpulseDenominator(frictionPosWorld,
   frictionDirectionWorld);
  float denom1 = body1.computeImpulseDenominator(frictionPosWorld,
   frictionDirectionWorld);
