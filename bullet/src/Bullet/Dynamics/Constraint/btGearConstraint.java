...
/**
 * The btGeatConstraint will couple the angular velocity for two bodies around given local axis and
 * ratio. See Bullet/Demos/ConstraintDemo for an example use.
 *
...
public class btGearConstraint extends btTypedConstraint implements Serializable {
 ...
 public btGearConstraint(btRigidBody rbA, btRigidBody rbB, final btVector3 axisInA,
 ...
 public void getInfo2(btConstraintInfo2 info) {
  final btVector3 globalAxisA = m_rbA.getWorldTransformPtr().transform3x3(new btVector3(m_axisInA));
  final btVector3 globalAxisB = m_rbB.getWorldTransformPtr().transform3x3(new btVector3(m_axisInB));
