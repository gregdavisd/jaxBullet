...
public class btContactConstraint extends btTypedConstraint {
 ...
 public btContactConstraint(btPersistentManifold contactManifold, btRigidBody rbA, btRigidBody rbB) {
...
///very basic collision resolution without friction
 public static float resolveSingleCollision(btRigidBody body1, btCollisionObject colObj2,
  ...
  final btVector3 rel_pos1 = new btVector3(contactPositionWorld).sub(body1.getWorldTransformPtr()
   .getOrigin());
  final btVector3 rel_pos2 = new btVector3(contactPositionWorld).sub(colObj2.getWorldTransformPtr()
   .getOrigin());
  ...
  float denom1 = body2 != null ? body2.computeImpulseDenominator(contactPositionWorld, normal) : 0.f;
  ...
  if (body2 != null) {
   body2.applyImpulse(new btVector3(normal).negate().scale(normalImpulse), rel_pos2);
  }
  return normalImpulse;
 }

///resolveSingleBilateral is an obsolete methods used for vehicle friction between two dynamic objects
 public static void resolveSingleBilateral(btRigidBody body1, final btVector3 pos1,
  ...
  final btVector3 rel_pos1 = new btVector3(pos1).sub(body1.getCenterOfMassPosition());
  final btVector3 rel_pos2 = new btVector3(pos2).sub(body2.getCenterOfMassPosition());
  //this jacobian entry could be re-used for all iterations
  final btVector3 vel1 = body1.getVelocityInLocalPoint(rel_pos1);
  final btVector3 vel2 = body2.getVelocityInLocalPoint(rel_pos2);
  final btVector3 vel = new btVector3(vel1).sub(vel2);
  btJacobianEntry jac = new btJacobianEntry(body1.getCenterOfMassTransform().getBasis().transpose(),
