 ...
 */
package com.leeheegee.throttle;
...
public class Throttle {
 ...
 /**
  * Limit the volume of requests going out over time.
  *
  * @param tps allowable ticks per second
  * @param max_updates number of allowable updates per tick
  */
 public Throttle(int tps, int max_updates) {
  this.tps = tps;
  this.max_updates = max_updates;
  updates_allowed=this.max_updates;
 }
