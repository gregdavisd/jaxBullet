...
public class ExampleBrowserFrame extends javax.swing.JFrame {
  ...
  java.awt.EventQueue.invokeLater(new Runnable() {
   ...
   public void run() {
    if (demo != null && demo.world() != null && demo.world().getDebugDrawer() != null) {
     ...
     frame.constraint_limits_check.setSelected((mode & DBG_DrawConstraintLimits) != 0);
 ...
 private void set_world_iterations() {
  if (demo != null && demo.world() != null && demo.world().getSolverInfo() != null) {
   demo.world().getSolverInfo().m_numIterations = (Integer) iterations_spinner.getValue();
  }
 }
 ...
 public static void main(String args[]) {
  ...
  java.awt.EventQueue.invokeLater(new Runnable() {
   ...
   private void init_example_browser(JTree tree) {
    ...
    DefaultMutableTreeNode node_character = new DefaultMutableTreeNode("Character");
  ...
  try {
   ...
   Logger.getLogger(ExampleBrowserFrame.class.getName()).log(Level.SEVERE, null, ex);
  }
  //</editor-fold>
 }
